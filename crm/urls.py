...
urlpatterns = [
    ...
    #url(r'^password-change/$', pwd_change, {'template_name': 'registration/password_change_form.html'}, {'post_change_redirect': 'crm:password_change_done'}, name='password_change_form'),
...
# restore password urls
    ...
    #{'post_change_redirect': '/password-reset/confirm/(?P<uidb64>[-\w]+)/(?P<token>[-\w]+)/$'},
